...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s outastracoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  outastracoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded outastracoin transaction") + "\n" +
              "  outastracoin-tx [options] -create [commands]   " + _("Create hex-encoded outastracoin transaction") + "\n" +
              "\n";
