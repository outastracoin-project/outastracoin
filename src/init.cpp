...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/outastracoin-project/outastracoin>";
    const std::string URL_WEBSITE = "<https://outastracoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Outastracoin version %s\n", FormatFullVersion());
}
