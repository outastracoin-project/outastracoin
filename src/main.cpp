...
#if defined(NDEBUG)
# error "Outastracoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x10cf47de8824d3e4f05877e2447c7665213fa432a4f45b4f21b16fd54ce3c7eb");
...
const string strMessageMagic = "Outastracoin Signed Message:\n";
...
{
    // Outastracoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3fa994d9991496c8d7b2609fbbabe0e560dca8455db7f56403d4b647c5efe170");
    }
...
bool InitBlockIndex() {
    ...
    loop
    {
        ...
        assert(block.hashMerkleRoot == uint256("0xc117f2cfa78bb65bc3a88d6cbafe05a96f54b69d9820387238f15bc5b0b07a8a"));
        block.print();
        //=====
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Outastracoin: increase each by adding ? to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("OutastracoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("OutastracoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static OutastracoinMiner(CWallet *pwallet)
{
    printf("OutastracoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Outastracoin-miner");
    ...
    try { loop {
        ...
        printf("Running OutastracoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("OutastracoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&OutastracoinMiner, pwallet));
}
