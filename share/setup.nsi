...
VIAddVersionKey ProductName Outastracoin
...
Section -Main SEC0000
    ...
    Delete /REBOOTOK $INSTDIR\outastracoin.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Outastracoin.lnk" $INSTDIR\outastracoin-qt.exe
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Uninstall Outastracoin.lnk" $INSTDIR\uninstall.exe
    ...
    WriteRegStr HKCR "outastracoin" "URL Protocol" ""
    WriteRegStr HKCR "outastracoin" "" "URL:Outastracoin"
    WriteRegStr HKCR "outastracoin\DefaultIcon" "" $INSTDIR\outastracoin-qt.exe
    WriteRegStr HKCR "outastracoin\shell\open\command" "" '"$INSTDIR\outastracoin-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\outastracoin-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Uninstall Outastracoin.lnk"
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Outastracoin.lnk"
    Delete /REBOOTOK "$SMSTARTUP\Outastracoin.lnk"
    ...
    DeleteRegKey HKCR "outastracoin"
